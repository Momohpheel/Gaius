...
<div style="margin: 100px 0px">
    <div class="uk-container" style="max-width: 600px">
        <div class="uk-card uk-card-default uk-card-body">
            ...
            <div class="uk-margin">
                <label class="uk-form-label" for="form-stacked-text">{{ __('Martic Number') }}</label>
                <div class="uk-form-controls">
                    <input class="uk-input @error('matricNumber') is-invalid @enderror" name="matricNumber" value="{{ old('matricNumber') }}" required autocomplete="matricNumber" autofocus id="matricNumber" type="text" >
                </div>
                @error('matricNumber')
            ...
            <div class="uk-margin">
                <label class="uk-form-label" for="form-stacked-text">{{ __('Full Name') }}</label>
                <div class="uk-form-controls">
                    <input class="uk-input @error('fullName') is-invalid @enderror" name="fullName" value="{{ old('fullName') }}" required autocomplete="fullName" autofocus id="fullName" type="text" >
                </div>
                @error('fullName')
                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <br>
                <a href="/student/login">Already have an account, Sign in here</a>
            </form>
        </div>
    </div>
</div>
