                ...
                <div class="uk-card uk-card-default uk-card-body" style="padding: 0px 0px;">
                    <div style="text-align: right">
                        ...
                        <div style="text-align: center;padding: 10px;background: rgba(39, 174, 96, 0.05);color: #27AE60 ">
                            <a href="{{url('/product/add')}}" style="text-decoration: none;color: #27AE60;font-weight: 600">+All Students</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body" style="padding: 0px 0px;">
                    <div style="text-align: right">
                        ...
                        <div style="text-align: center;padding: 10px;background: rgba(244, 0, 35, 0.05);color: #F40023 ">
                            <a href="{{url('/customers')}}" style="text-decoration: none;color: #F40023;font-weight: 600">+Add Prescription</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body" style="padding: 0px 0px;">
                    <div style="text-align: right">
                        ...
                        <div style="text-align: center;padding: 10px;background: rgba(2, 0, 75, 0.05);color: #02004B ">
                            <a href="{{url('/customers')}}" style="text-decoration: none;color: #02004B;font-weight: 600">+Check Appointments</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body" style="padding: 0px 0px;">
                    <div style="text-align: right">
                        ...
                        <div style="text-align: center;padding: 10px;background: rgba(182, 110, 2, 0.05);color: #B66E02 ">
                            <a href="{{url('/vendors')}}" style="text-decoration: none;color: #B66E02;font-weight: 600">+Add Medications</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-card uk-card-default uk-card-body" style="padding: 0px 0px;">
                    <div style="text-align: right">
                        ...
                        <div style="text-align: center;padding: 10px;background: rgba(13, 111, 225, 0.05);color: #0D6FE1 ">
                            <a href="{{url('/customers')}}" style="text-decoration: none;color: #0D6FE1;font-weight: 600; ">+Add Doctor</a>
                        </div>
                    </div>
                </div>
            </div>
