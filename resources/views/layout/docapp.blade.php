    ...
    <div id="offcanvas-nav-primary" uk-offcanvas="mode: push; overlay: true">
        <div class="uk-offcanvas-bar uk-flex uk-flex-column">
            ...
            <ul class="uk-nav uk-nav-default">
                <li class="uk-parent">
                    <ul class="uk-nav-sub">
                        <li style="background-color: #154D34;"><a href="{{url('/doctor/dashboard')}}"><ion-icon name="pie-chart-sharp"></ion-icon> <span class="side-menu-text">Dashboard</span></a></li>
                        <li><a href="{{url('/doctor/appointment')}}"><ion-icon name="list"></ion-icon>  <span class="side-menu-text">Appointments</span></a></li>
                        <li><a href="{{url('/doctor/all')}}"><ion-icon name="people"></ion-icon>  <span class="side-menu-text">Doctors</span></a></li>
                        <li><a href="{{url('/doctor/students')}}"><ion-icon name="people"></ion-icon>  <span class="side-menu-text">Students</span></a></li>
                        <li><a href="{{url('/doctor/medication')}}"><ion-icon name="cube"></ion-icon>  <span class="side-menu-text">Medications</span></a></li>
                        <li><a href="{{url('/doctor/report')}}"><ion-icon name="reader-outline"></ion-icon>  <span class="side-menu-text">Report</span></a></li>
